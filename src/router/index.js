...
import InformeDePedidos from '../views/Estadisticas/InformeDePedidos.vue';
  ...
  routes: [
    ...
    },
    {
      ...
      children:[
        ...
        {
          path:'informe_pedidos_domicilio',
          name:'informe_pedidos_domicilio',
          component: InformeDePedidos
        }
      ],
      beforeEnter:(to,from)=>{
          tienePermisos(to.meta.permisosRequeridos,store.state.permisos);
